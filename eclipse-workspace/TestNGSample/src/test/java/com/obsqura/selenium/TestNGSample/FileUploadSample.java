...
public class FileUploadSample extends Base{
	...
	@Test
	public void fileUploadInIlovePDF() throws IOException, InterruptedException {
		driver.navigate().to("https://www.ilovepdf.com/word_to_pdf");
		WebElement selectFile=driver.findElement(By.xpath("//a[@id='pickfiles']"));
		selectFile.click();
		//Thread.sleep(500);
		Runtime.getRuntime().exec("\"C:\\Users\\anjuc\\OneDrive\\Desktop\\JAVA_TRAINING\\AutoIT\\FileUpload.exe\"");
	}
}
